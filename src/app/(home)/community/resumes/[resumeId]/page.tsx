...
export default function Page({ params }: Props) {
  ...
  return (
    <div className="flex flex-col space-y-4 items-center justify-center w-full h-full p-24">
      ...
      >
        <div className="flex flex-row">
          <div className="flex flex-col flex-grow">
            <div className="text-5xl font-semibold mb-4">김남기</div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            키웠습니다. 또한, Spring Cloud Netflix Eureka를 활용한 MSA 환경에서
            개발을 진행한 경험이 있으며, 커서 기반 페이지네이션을 적용해 성능을
            개선한 경험이 있습니다.
          </div>
        </div>
        {/* 경력 */}
        ...
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>
                일관된 에러 처리와 사용자 정의 예외를 통해 안정적인 서비스 제공
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>
                채팅방별 메시지 구독 및 발송 기능을 제공하여 실시간 대화 경험을
                강화
              </li>
            </ul>
        ...
        <div className="space-y-4">
          ...
          <div className="flex w-full space-x-2 items-center bg-gray-50 border border-gray-400 rounded-md p-2">
      ...
      <Button onClick={() => toPDF()}>pdf로 저장</Button>
    </div>
  );
}
