...
interface MemberUpdateRequestDTO {
  name: string;
  phoneNUmber: string;
  email: string;
  position: string;
...
export default function Page() {
  ...
  const [imageSrc, setImageSrc] = useState<string>("/images/gitfolio-logo.png");
  ...
  function onSubmit(data: z.infer<typeof OnboardingFormSchema>) {
    ...
    //   if (key === "avatarUrl") {
    //     formData.append("avatarUrl", imageFile as Blob);
    //   } else {
    //     formData.append(key, data[key]);
    //   }
    // });

    // mutate({ accessToken: "sdf", data: formData });
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <header className="mb-8 bg-white h-full p-4">
                ...
                <CardContent key={field.id}>
                  <div className="space-y-4">
                    ...
                    <div className="flex w-full gap-2 justify-between">
                      ...
                      {/* <FormField
                        control={form.control}
                        name={`workExperiences.${index}.workStartedAt`}
                        render={({ field }) => (
                          <FormItem className="flex-1">
                      ...
                      /> */}
                      <CustomMonthRangePicker form={form} index={index} />
                    </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex w-full justify-center items-center gap-2 border border-gray-200 rounded-md">
                        {/* {field.url?.includes("github.com") ? (
                          <Github className="aspect-square w-14 h-14 p-4 border-r border-gray-200" />
                        ) : field.url?.includes("linkedin.com") ? (
                          <Linkedin className="aspect-square w-14 h-14 p-4 border-r border-gray-200" />
                        ) : field.url?.includes("tistory.com") ? (
                          <TistoryIcon className="aspect-square w-14 h-14 p-4 border-r border-gray-200" />
                        ) : (
                          <Link className="aspect-square w-14 h-14 p-4 border-r border-gray-200" />
                        )} */}
